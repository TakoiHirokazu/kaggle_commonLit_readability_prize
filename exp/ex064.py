...
MODEL_PATH = '../models/xlnet/xlnet-base-cased-pytorch_model.bin'
tokenizer = XLNetTokenizer.from_pretrained(
    "../models/xlnet/xlnet-base-cased-spiece.model")
...
class xlnet_base_model(nn.Module):
    def __init__(self):
        ...
        xlnet_config = XLNetConfig.from_json_file(
            '../models/xlnet/xlnet-base-cased-config.json')
        ...
        self.xlnet_model = XLNetModel.from_pretrained(
            MODEL_PATH, config=xlnet_config)
    ...
    def forward(self, ids, mask, token_type_ids):
        # pooler
        emb = self.xlnet_model(ids, attention_mask=mask, token_type_ids=token_type_ids)[
            "last_hidden_state"]
