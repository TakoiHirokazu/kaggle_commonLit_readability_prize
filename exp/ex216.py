...
class deberta_xxlarge_model(nn.Module):
    def __init__(self):
        super(deberta_xxlarge_model, self).__init__()
        self.deberta_model = AutoModel.from_pretrained(MODEL_PATH,
